        ...
        <div class="container-fluid mt-3">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Commentaires en attente de validation:</h4>
                                ...
                                <table class="table table-striped table-bordered zero-configuration">
                                    ...
                                    <?php foreach ($comments as $comment => $com) { ?>
                                        <tr>
                                            ...
                                            <th>
                                                <a href="<?=HTTP.'comments?validate='.$com->getId();?>" class="btn mb-1 btn-success">Valider <span class="btn-icon-right"><i class="fa fa-check"></i></span></a>
